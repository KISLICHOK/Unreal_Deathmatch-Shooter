...
void ASTUGameModeBase::Killed(AController* KillerController, AController* VictimController)
{
	...
	const bool AreEnemies = STUUtils::AreEnemies(KillerController, VictimController);
	
	if (KillerPlayerState && AreEnemies)
	{
		KillerPlayerState->AddKill();
	}

	if (VictimPlayerState && AreEnemies)
	{
...
{
	const auto RespawnAvaiable = RoundCountDown > MinRoundTimeForRespawn + GameData.RespawnTime;
	if (!RespawnAvaiable) return;
